...
## Approach
Seguir a **Approach 1** do `sdd-explore`: 
Refatorar apenas o construtor do bot. Modificar a variável `prompt` em `summarizeAllWithGemini` e a concatenação no loop de mensagens.
